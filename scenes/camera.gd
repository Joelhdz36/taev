...
func set_camera_values():
	...
	player_offset.y = roundi(screen_size.y * 0.05)
...
func follow_player(_delta:float):
	...
	var camera_offset:Vector2 = Vector2(player_offset.x * _player_direction.x,-player_offset.y - roundi(player_offset.y * 0.5))
